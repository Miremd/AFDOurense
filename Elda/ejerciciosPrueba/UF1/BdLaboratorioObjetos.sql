tipoobjetoobjetos-- MySQL Workbench Forward Engineering
...
CREATE TABLE IF NOT EXISTS `BDlaboratoriObjetos`.`tipoObjeto` (
  `idtipoObjetos` INT NOT NULL AUTO_INCREMENT,
  `cantidad` VARCHAR(45) NULL,
  PRIMARY KEY (`idtipoObjetos`),
  UNIQUE INDEX `idtipoObjetos_UNIQUE` (`idtipoObjetos` ASC) VISIBLE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `BDlaboratoriObjetos`.`objetos` (
  ...
  `tipoObjeto_idtipoObjetos` INT NOT NULL,
  PRIMARY KEY (`codObjeto`, `laboratorios_numLaboratorio`, `tipoObjeto_idtipoObjetos`),
  ...
  INDEX `fk_objetos_tipoObjeto1_idx` (`tipoObjeto_idtipoObjetos` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_objetos_tipoObjeto1`
    FOREIGN KEY (`tipoObjeto_idtipoObjetos`)
    REFERENCES `BDlaboratoriObjetos`.`tipoObjeto` (`idtipoObjetos`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
