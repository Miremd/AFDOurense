...
-- -----------------------------------------------------
-- Table `Compañia_Aerea`.`Pilotos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Compañia_Aerea`.`Pilotos` (
  `idPiloto1` INT NOT NULL,
  `Nombre y apellidos` VARCHAR(45) NULL,
  `Direccion` VARCHAR(45) NULL,
  `Telefono` VARCHAR(45) NULL,
  `Pilotos_idPiloto1` INT NOT NULL,
  PRIMARY KEY (`idPiloto1`, `Pilotos_idPiloto1`),
  UNIQUE INDEX `idPiloto1_UNIQUE` (`idPiloto1` ASC) VISIBLE,
  INDEX `fk_Pilotos_Pilotos1_idx` (`Pilotos_idPiloto1` ASC) VISIBLE,
  CONSTRAINT `fk_Pilotos_Pilotos1`
    FOREIGN KEY (`Pilotos_idPiloto1`)
    REFERENCES `Compañia_Aerea`.`Pilotos` (`idPiloto1`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `Compañia_Aerea`.`PilotosEnAvion`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Compañia_Aerea`.`PilotosEnAvion` (
  `Pilotos_idPiloto1` INT NOT NULL,
  `Avion_id_Avion` INT NOT NULL,
  PRIMARY KEY (`Pilotos_idPiloto1`, `Avion_id_Avion`),
  INDEX `fk_Pilotos_has_Avion_Avion1_idx` (`Avion_id_Avion` ASC) VISIBLE,
  INDEX `fk_Pilotos_has_Avion_Pilotos1_idx` (`Pilotos_idPiloto1` ASC) VISIBLE,
